    ...
    <div class="container">
        <center>
            ...
            <div class="middle">
                ...
                <div id="login">
                    ...
                    <form action="{{route('logging')}}" method="post">
                        ...
                        <fieldset class="clearfix">
                            ...
                            <div>
                                <span style="width:48%; text-align:left;  display: inline-block;"><a class="small-text" href="{{route('register')}}">Register?</a></span>
                ...
                <div class="logo"><img src="https://talentconnects.com.np/img/logo.png" style="background-color: transparent" width="430px"height="190px">
